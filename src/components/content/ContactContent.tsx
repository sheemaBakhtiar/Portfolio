      ...
      {!contactMethod ? (
        <>
          ...
          <div className="space-y-3">
            ...
            >
              <span className="text-green-400">1.</span> Email
            </button>
            ...
            <button 
              ...
              className="block w-full px-4 py-2 text-left border border-gray-700 rounded hover:bg-gray-800"
            >
              <span className="text-green-400">2.</span> LinkedIn
            </button>
            ...
            <button 
              ...
              className="block w-full px-4 py-2 text-left border border-gray-700 rounded hover:bg-gray-800"
            >
              <span className="text-green-400">3.</span> GitHub
            </button>
            ...
            <button 
              ...
              className="block w-full px-4 py-2 text-left border border-gray-700 rounded hover:bg-gray-800"
            >
              <span className="text-green-400">4.</span> Leave a message
            </button>
          </div>
        </>
      ) : contactMethod === 'email' ? (
          ...
          {isSent ? (
            ...
            <>
              ...
              <textarea
                ...
                className="w-full h-32 p-2 bg-gray-800 border border-gray-700 rounded focus:outline-none focus:border-green-500 text-white resize-none"
